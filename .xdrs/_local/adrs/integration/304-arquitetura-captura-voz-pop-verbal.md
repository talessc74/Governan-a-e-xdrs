---
name: _local-adr-policy-304-arquitetura-captura-voz-pop-verbal
...
# _local-adr-policy-304: Arquitetura de captura por voz do SGCCCO — ASR/TTS de terceiro + LLM só para extração
...
- Este agente é reaplicado, com a mesma arquitetura de duas camadas, em quatro momentos: Fase 1 (Recebimento), Fase 2 (Limpeza até Secagem), Fase 4 (Captura de Curadoria — ver `_local-adr-policy-302`) e Fase 6 (fechamento de custódia no Galpão — ver `_local-adr-policy-303`).
...
- `_local-adr-policy-302` — Redesenho dos agentes de IA da Fase de Curadoria
- `_local-adr-policy-303` — Modelo de dados do fluxo SGCCCO
